      ...
      <div class="<?php echo $loginrow; ?>">
          <div class="<?php echo $formarea; ?>">
            ...
            <div class="form-group">
                ...
                <input autocomplete="off" type="text" class="form-control" id="authUser" name="authUser" placeholder="<?php echo xla('Username:');?>" readonly onfocus="this.removeAttribute('readonly');"/>
            </div>
            <div class="form-group">
                <label for="clearPass" class="text-right"><?php echo xlt('Password:'); ?></label>
                <input autocomplete="off" type="text" class="form-control" id="clearPass" name="clearPass" placeholder="<?php echo xla('Password:');?>" readonly onfocus="this.removeAttribute('readonly');"/>  
            </div>
            <?php echo $div_app; ?>
